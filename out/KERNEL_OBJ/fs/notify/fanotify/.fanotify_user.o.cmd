cmd_fs/notify/fanotify/fanotify_user.o := clang -Wp,-MD,fs/notify/fanotify/.fanotify_user.o.d -nostdinc -isystem /usr/lib/llvm-android-6.0-4691093/lib64/clang/6.0.2/include -I/buildd/sources/arch/arm64/include -I./arch/arm64/include/generated/uapi -I./arch/arm64/include/generated  -I/buildd/sources/include -I./include -I/buildd/sources/arch/arm64/include/uapi -I/buildd/sources/include/uapi -I./include/generated/uapi -include /buildd/sources/include/linux/kconfig.h -I/buildd/sources/fs/notify/fanotify -Ifs/notify/fanotify -D__KERNEL__ -mlittle-endian -Qunused-arguments -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -fno-PIE -mno-implicit-float -fno-asynchronous-unwind-tables -fno-pic -Wno-asm-operand-widths -O2 -Werror -Wframe-larger-than=2048 -fstack-protector-strong --target=aarch64-linux-gnu --gcc-toolchain=/usr -Wno-unused-variable -Wno-format-invalid-specifier -Wno-gnu -Wno-address-of-packed-member -Wno-duplicate-decl-specifier -Wno-tautological-compare -mno-global-merge -no-integrated-as -fno-omit-frame-pointer -fno-optimize-sibling-calls -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-merge-all-constants -fno-stack-check -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror=incompatible-pointer-types -Wno-initializer-overrides -Wno-unused-value -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-uninitialized    -DKBUILD_BASENAME='"fanotify_user"'  -DKBUILD_MODNAME='"fanotify_user"' -c -o fs/notify/fanotify/.tmp_fanotify_user.o /buildd/sources/fs/notify/fanotify/fanotify_user.c

source_fs/notify/fanotify/fanotify_user.o := /buildd/sources/fs/notify/fanotify/fanotify_user.c

deps_fs/notify/fanotify/fanotify_user.o := \
    $(wildcard include/config/fanotify/access/permissions.h) \
    $(wildcard include/config/compat.h) \
  /buildd/sources/include/linux/fanotify.h \
  /buildd/sources/include/uapi/linux/fanotify.h \
  ...
  /buildd/sources/fs/notify/fanotify/../../mount.h \
  /buildd/sources/include/linux/fs_pin.h \
  /buildd/sources/fs/notify/fanotify/../fdinfo.h \
  /buildd/sources/include/linux/proc_fs.h \
    $(wildcard include/config/proc/uid.h) \
  /buildd/sources/fs/notify/fanotify/fanotify.h \
